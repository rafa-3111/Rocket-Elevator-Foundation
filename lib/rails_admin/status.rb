module RailsAdmin
    module Config
      module Actions
        class Status < RailsAdmin::Config::Actions::Base
          ...
          register_instance_option :controller do
            proc do
              ...
              @history = @autiting_adapter && @auditing_adapter.latest(@action.auditing_versions_limit) || []
              if @action.statistics?
                @abstract_models = RailsAdmin::Config.visible_models(controller: self).collect(&:abstract_models)
