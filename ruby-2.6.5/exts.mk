...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/coverage/. ext/pathname/. ext/ripper/. ext/digest/. \
	     ext/digest/bubblebabble/. ext/digest/md5/. \
	     ext/digest/rmd160/. ext/digest/sha1/. ext/digest/sha2/. \
	     ext/date/. ext/fiddle/. ext/syslog/. ext/etc/. \
	     ...
	     ext/cgi/escape/. ext/nkf/. ext/fcntl/. ext/dbm/. \
	     ext/rubyvm/. ext/bigdecimal/. ext/bigdecimal/util/. \
	     ext/openssl/. ext/json/. ext/json/generator/. \
	     ext/json/parser/. ext/readline/. ext/pty/. \
	     ext/racc/cparse/. ext/socket/. ext/zlib/. \
	     ext/rbconfig/sizeof/. ext/stringio/. ext/psych/. \
	     ext/objspace/. ext/gdbm/. ext/io/console/. \
	     ext/io/nonblock/. ext/io/wait/. ext/continuation/. \
	     ext/sdbm/. ext/strscan/. ext/fiber/.
EXTOBJS = dmyext.o
